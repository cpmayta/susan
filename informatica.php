...
<div class="container-fluid">
  ...
  <div class="container">
    ...
    <div class="row">
            <div class="col-md-6">
                <img class="img-responsive" src="/img/informatica.jpg" alt="">
            </div>
            <div class="col-md-6">
                <h2>Informática</h2>
                ...
                <p>Analizamos el proceso de atención de centros de Salud, Puestos de salud, clínicas y creamos el software necesario para el correcto control de acuerdo a normas técnicas de salud.</p>
            </div>
    </div>
