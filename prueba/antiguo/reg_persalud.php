	...
	<div id="page-bgbtm">
		<div id="content">
			<div class="post">
                ...
                <tr>
                    <td><b>Password</b></td>
                    <td COLSPAN=3><input type="password" name="pass_per" size="25" placeholder="password..." required/></td>
					<td><h6>*</h6></td>
                </tr>
				<tr>
                    <td><b>Estado</b></td>
                    <td COLSPAN=3><input type="text" name="estado_per" size="25" readonly="readonly" value="ACTIVO" /></td>
					<td><h6>*</h6></td>
                </tr>
