          ...
          <div class="col-md-8">
            <div class="row">
                  <div class="col-xs-12">
                      ...
                      <ol class="breadcrumb">
                          ...
                          <li class="active">Busqueda de pacientes</li>
                      </ol>
                  </div>
            </div>
            <form action="" method="post" class="form-horizontal">
                ...
                <div class="form-group has-success has-feedback">
                      <div class="col-md-12">
                        <select  class="form-control input-sm" required name="list" class ="pass">
                 ...
                 <div class="form-group has-success has-feedback">
                    <div class="col-md-12">
                    <input class="form-control input-sm" name="pat_pac" type="search" placeholder="Nombre, Historia Clínica o DNI">
                ...
                <?php
                    ...
                    switch ($_POST['list']){
                      ...
                      $pat_pac = $_POST['pat_pac'];
                      $controlador = new controlador(); 
                      $controlador->pac_buscar_dni($pat_pac);
                      break;
                    }
                ?>
