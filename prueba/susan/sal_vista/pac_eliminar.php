            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Formulario
                        <small>de eliminar</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="pac_buscar.php">Búsqueda</a>
                        </li>
                        <li class="active">Eliminar datos del Paciente</li>
                    </ol>
                </div>
            </div>
            <form action="../sal_controladores/pac_eliminar.php" method="post" class="form-horizontal">
                <?php
                      include ("../sal_modelo/controlador.php");
                      $his_clinica      = $_REQUEST['his_clinica'];
                      $controlador = new controlador(); 
                      $controlador->eliminarpaciente($his_clinica);
                ?>
            </form>
          </div>
          <div class="col-md-4">
